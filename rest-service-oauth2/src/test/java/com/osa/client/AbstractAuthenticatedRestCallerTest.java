...
abstract class AbstractAuthenticatedRestCallerTest {
    ...
    private final AbstractAuthenticatedRestCaller restCaller;

    protected AbstractAuthenticatedRestCallerTest(final AbstractAuthenticatedRestCaller restCaller) {
